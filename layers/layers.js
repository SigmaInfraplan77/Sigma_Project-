...
var format_UndergroundDrainageSchemecopy_5 = new ol.format.GeoJSON();
var features_UndergroundDrainageSchemecopy_5 = format_UndergroundDrainageSchemecopy_5.readFeatures(json_UndergroundDrainageSchemecopy_5, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_UndergroundDrainageSchemecopy_5 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_UndergroundDrainageSchemecopy_5.addFeatures(features_UndergroundDrainageSchemecopy_5);
var lyr_UndergroundDrainageSchemecopy_5 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_UndergroundDrainageSchemecopy_5, 
                style: style_UndergroundDrainageSchemecopy_5,
                popuplayertitle: "Underground Drainage Scheme copy",
                interactive: true,
                title: '<img src="styles/legend/UndergroundDrainageSchemecopy_5.png" /> Underground Drainage Scheme copy'
            });
...
lyr_GoogleTerrainHybrid_0.setVisible(true);lyr_India_1.setVisible(true);lyr_Architectural3DMapping_2.setVisible(true);lyr_CityDevelopmentPlanCitySanitationPlan_3.setVisible(true);lyr_SolarEnergy_4.setVisible(true);lyr_UndergroundDrainageSchemecopy_5.setVisible(true);lyr_HydraulicModelStudies_6.setVisible(true);lyr_DrinkingWaterSupplyWorks_7.setVisible(true);
var layersList = [lyr_GoogleTerrainHybrid_0,lyr_India_1,lyr_Architectural3DMapping_2,lyr_CityDevelopmentPlanCitySanitationPlan_3,lyr_SolarEnergy_4,lyr_UndergroundDrainageSchemecopy_5,lyr_HydraulicModelStudies_6,lyr_DrinkingWaterSupplyWorks_7];
lyr_India_1.set('fieldAliases', {'fid': 'fid', 'cat': 'cat', 'Length': 'Length', });
...
lyr_UndergroundDrainageSchemecopy_5.set('fieldAliases', {'Name': 'Name', 'Descri.': 'Descri.', });
...
lyr_India_1.set('fieldImages', {'fid': 'TextEdit', 'cat': 'TextEdit', 'Length': 'TextEdit', });
...
lyr_UndergroundDrainageSchemecopy_5.set('fieldImages', {'Name': 'TextEdit', 'Descri.': 'TextEdit', });
...
lyr_India_1.set('fieldLabels', {'fid': 'no label', 'cat': 'no label', 'Length': 'no label', });
...
lyr_UndergroundDrainageSchemecopy_5.set('fieldLabels', {'Name': 'inline label - visible with data', 'Descri.': 'inline label - visible with data', });
